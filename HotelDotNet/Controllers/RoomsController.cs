...
namespace HotelDotNet.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,RoomType,RoomSize")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Description,RoomType,RoomSize")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
